...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(MainActivity.this, "Amusez vous ^^ ", Toast.LENGTH_LONG).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (itemId) {
            ...
            case R.id.nav_apprendre_chiffres:
                intent = new Intent(MainActivity.this, ChoixChiffre.class);
                startActivity(intent);
                break;
            ...
            case R.id.nav_voir_videos:
                intent = new Intent(MainActivity.this, Histoires.class);
                startActivity(intent);
                break;
            case R.id.nav_jouer:
                intent = new Intent(MainActivity.this, Photos.class);
